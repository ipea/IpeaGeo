...
{
    public partial class FormDadosPainelEspacial : Form
    {
        ...
        public FormDadosPainelEspacial()
        {
            InitializeComponent();
        }
        ...
        private void FormBaseModelagemEspacial_Load(object sender, EventArgs e)
        {
        ...
        {
            FormQuickHelp frm = new FormQuickHelp();
            frm.TipoModelo = "Regressão com Dados de Painel";
            frm.TextoAjuda = "Livro do Woodrige ...";
            frm.Show();
        }
