...
{
    public partial class FormDistribuicoesParametrics : Form
    {
        ...
        private double[,] m_vetor;
        public double[,] M_Vetor
        {
            get { return m_vetor; }
            set { m_vetor = value; }
        }
        ...
        public FormDistribuicoesParametrics()
        {
            InitializeComponent();
        }

        private BLogicDistribuicoesContinuas m_blc = new BLogicDistribuicoesContinuas();
        ...
        private void AtualizaTabelaDados(bool atualizaUControl)
        {
            ...
            string[] lista_estatisticas = this.m_blc.ListaDistribuicoesContinuas;
