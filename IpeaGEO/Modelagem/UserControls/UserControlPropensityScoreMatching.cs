...
namespace IpeaGeo
{
    public partial class UserControlPropensityScoreMatching : UserControl
    {
        public UserControlPropensityScoreMatching()
        {
            InitializeComponent();
        }
        ...
        public string LabelListaVarsDependentes
        {
            set { this.groupBox2.Text = value; }
        }

        public string LabelListaVarsIndependentes
        {
            set { this.groupBox3.Text = value; }
        }
        ...
        private void btnAddResponseVariable_Click(object sender, EventArgs e)
        {
                ...
                && this.lstVariaveisDisponiveis.SelectedIndex < this.lstVariaveisDisponiveis.Items.Count)
            {
               ...
               // IpeaGEO.Modelagem.FormPropensityScore.cmbOutcome.Items.Remove(this.lista_dep_variaveis);
