...
{
    public partial class frmAnaliseFatorial : Form
    {
        #region variáveis internas 

        BlogicAnaliseFatorial comprinc = new BlogicAnaliseFatorial();
        ...
        public string LabelTabelaDados
        {
            set
            {
                ...
                this.Text = "Análise Fatorial - " + value;
            }
        }

        public frmAnaliseFatorial()
        {
            InitializeComponent();
        }
        ...
        private void EstimaModelo()
        {
            ...
            clsUtilTools clt = new clsUtilTools();
            BlogicAnaliseFatorial blr = new BlogicAnaliseFatorial();
            ...
            blr.cmbtipoestimacao = cmbmetodoestimacao.SelectedItem.ToString();
            blr.ckbvarcovar = ckbapresentavarcovar.Checked;
            blr.ckbcorrel = ckbapresentacorrelacao.Checked;
            blr.ckbestimacoef = ckbestimacaocoef.Checked;
            blr.ckbescore = ckbescorecomponentes.Checked;
            blr.ckbrotacao = ckbrotation.Checked;
            blr.AdicionaNovaVariaveis = ckbIncluirNovasVariaveisTabelaDados.Checked;
            ...
            blr.EstimarAnaliseFatorial(ref perc);
        ...
        private void btnExecutar_Click(object sender, EventArgs e)
        {
            ...
            {
                this.lblProgressBar.Text = "Houve problemas nos cálculos para a análise fatorial";
                this.lblProgressBar.Visible = true;

                Cursor = Cursors.Default;
                MessageBox.Show(er.Message, "Análise Fatorial", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
        ...
        private void FormComponentesPrincipais_Load(object sender, EventArgs e)
        {
            ...
            cmbmetodoestimacao.Text = "Componentes Principais";
        ...
        private void ckbescorecomponentes_CheckedChanged(object sender, EventArgs e)
        {
            if (ckbescorecomponentes.Checked)
            {
                ...
                cmbmetodoescore.Enabled = true;
                cmbmetodoescore.Text = "Mínimos Quadrados Ponderados";
                if (ckbrotation.Checked) cmbrotation.Enabled = true;
                ckbrotation.Enabled = true;
                ckbBartlet.Enabled = true;
            ...
            else
            {
                ...
                cmbmetodoescore.Enabled = false;
                cmbmetodoescore.Text = "";
                cmbrotation.Enabled = false;
                ckbrotation.Enabled = false;
                ckbBartlet.Enabled = false;
                numericUpDown1.Enabled = false;
        ...
        private void ckbrotation_CheckedChanged(object sender, EventArgs e)
        {
            if (ckbrotation.Checked)
            {
