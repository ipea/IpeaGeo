...
namespace IpeaGEO
{
    public class clsUtilOptimization
    {
        ...
        private int maxiter = 1000;			    		//maximum number of iterations allowed
        private double tolerancia_parms = 1.0e-6;		//tolerance for the change in parameters
        private double tolerancia_grad = 1.0e-8;		//tolerance for the gradient
        private double tolerancia_func = 1.0e-8;		//tolerance for the norm of nonlinear system of equations
        private double tolerancia_check = 1.0e-6;		//tolerance for checking the nonlinear system of equatios solution
    ...
    internal class Fminsearch
    {
        ...
        /// <summary>Returns the optimization result.</summary>
        public string GetMessage() { return this.message; }

        /// <summary>Sets the tolerance for x deviations (default = 1.0e-4).</summary>
        public void SetTolX(double t) { this.tolx = t; }

        /// <summary>Sets the tolerance for function deviations (default = 1.0e-4).</summary>
        public void SetTolF(double t) { this.tolf = t; }

        /// <summary>Sets the maximum number of function evaluations (default = 200*number of variables).</summary>
        public void SetMaxFun(int m) { this.maxfun = m; }

        /// <summary>Sets the maximum number of iterations (default = 200*number of variables).</summary>
