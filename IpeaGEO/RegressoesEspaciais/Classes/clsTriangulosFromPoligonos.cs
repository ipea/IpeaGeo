...
{
    public class clsTriangulosFromPoligonos
    {
        public clsTriangulosFromPoligonos()
        {
        }
        
        protected ArrayList m_px = new ArrayList();
        protected ArrayList m_py = new ArrayList();
        protected ArrayList m_triangulos = new ArrayList();
        protected ArrayList m_areas_triangulos = new ArrayList();
        protected ArrayList m_centroids_triangulos = new ArrayList();
        protected ArrayList m_tipo_triangulos = new ArrayList();
        protected bool m_area_calculada = false;

        protected double m_max_x = double.NegativeInfinity;
        protected double m_max_y = double.NegativeInfinity;
        protected double m_min_x = double.PositiveInfinity;
        protected double m_min_y = double.PositiveInfinity;
        ...
        protected bool IsInTriangulo(double x0, double y0, double[,] c)
        {
        ...
        protected bool AddTriangulo(bool poligono_externo)
        {
