...
namespace IpeaGeo
{
    public partial class UserControlSelecaoDoisBlocosVariaveis : UserControl
    {
        public UserControlSelecaoDoisBlocosVariaveis()
        {
            InitializeComponent();
        }
        ...
        public string LabelVariaveisDisponiveis
        {
            get { return groupBox1.Text; }
            set { groupBox1.Text = value; }
        }

        public string LabelVariaveisBlocoSuperior
        {
            get { return groupBox3.Text; }
            set { groupBox3.Text = value; }
        }

        public string LabelVariaveisBlocoInferior
        {
            get { return groupBox4.Text; }
            set { groupBox4.Text = value; }
        }
        ...
        public string[] VariaveisBlocoSuperior
        {
        ...
        public string[] VariaveisBlocoInferior
        {
